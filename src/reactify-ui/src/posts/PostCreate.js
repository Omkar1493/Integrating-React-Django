    ...
    return (
        <form onSubmit={this.handleSubmit} ref= {(el)=> this.postCreateForm=el}>
            <div className='form-group'>
                ...
                <input type= 'text' id = 'title' name='title' className='form-control' placeholder='Blog Post Title' ref = {this.postTitleRef} onChange={this.handleInputChange} required='required'/>
            </div>
            <div className='form-group'>
            ...
            <div className='form-group'>
                <label for='draft'>
                <input type= 'checkbox' checked={this.state.draft} id = 'draft' name='draft' className='form-control' placeholder='' onChange={this.handleDraftChange} />
                Draft</label>
                <button onClick={(event)=> {event.preventDefault(); this.handleDraftChange()}}>Toggle Draft</button>    
            </div>
            <div className='form-group'>
                <label for='publish'>Publish Date</label>
                <input type= 'date' id = 'publish' name='publish' className='form-control' placeholder='Publish Post content' onChange={this.handleInputChange} value={publish  } required='required'/>     
            </div>
